            ...
            <div class="card shadow-md">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a class="btn btn-primary btn-sm" href="{{ route('actividad-economica.create') }}">Nuevo registro</a>
                    </div>
                </div>
...
<script>
    ...
    var obtener_data_editar = function(tbody,table){
         $(tbody).on("click","a.editar",function(e){
            ...
            var id = data.id;
             window.location.href = "/actividad-economica/" + id + "/edit";
          });
             ...
             Swal.fire({
                  ...
                  cancelButtonText: 'Cancelar'
                   ...
                   if (result.value) {
                      ...
                      axios.delete('/actividad-economica/'+id)
                          .then(response => {
